...
import stepik.contactsApp.dao.ContactDAO;
...
public class ContactService implements ContactServiceInterface {
    ...
    @Autowired
    public ContactService(ContactDAO contactRepository, ModelMapper modelMapper) {
    ...
    public Contact createContact(CreateContactDTO dto) {
        ...
        contactRepository.findByPhone(dto.getTelephone())
                .ifPresent(contact -> {
